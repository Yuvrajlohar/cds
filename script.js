document.addEventListener('DOMContentLoaded', function() {
    ...
    const coursesByCategory = {
        web: ["HTML & CSS", "JavaScript", "React", "Node.js", "React.js", "Fullstack"],
        data: ["Python", "Pandas", "Machine Learning"],
        design: ["Figma", "Adobe XD", "UI/UX", "Canva", "Canva", "Canva", "Canva", "Canva"],
        marketing: ["Digital Marketing", "SEO", "Content Marketing"] // Added Marketing courses
    };
